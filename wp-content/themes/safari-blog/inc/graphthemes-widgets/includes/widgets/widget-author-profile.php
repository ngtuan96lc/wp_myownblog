...
function safari_blog_register_author_profile_widget() {
    register_widget( 'Graphthemes_Author_Profile' );
}
add_action( 'widgets_init', 'safari_blog_register_author_profile_widget' );
...
if( ! class_exists( 'Graphthemes_Author_Profile' ) ) : 
    ...
    class Graphthemes_Author_Profile extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                'safari_blog_widget_author_profile', // Base ID
                __( 'Graphthemes: Author Profile', 'safari-blog' ), // Name
                array( 'description' => __( 'An Author Profile Widget', 'safari-blog' ), ) // Args
            );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            if ( !filter_var( $image, FILTER_VALIDATE_URL ) === false ) {
                $attachment_id = $obj->safari_blog_widget_get_attachment_id( $image );
            }
            ...
            <?php    
                $html = ob_get_clean();
                echo apply_filters( 'safari_blog_widget_author_profile_widget_filter', $html, $args, $instance );
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'safari-blog' ); ?></label> 
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>"><?php esc_html_e( 'Author Name', 'safari-blog' ); ?></label> 
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'name' ) ); ?>" type="text" value="<?php echo esc_attr( $name ); ?>" />
            </p>
            
            <p>
                <label><?php esc_html_e('Display photo from:','safari-blog'); ?></label>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'author-image-option' . '-gravatar' ) );?>" class="radio-btn-wrap"><?php esc_html_e('Gravatar', 'safari-blog');?></label>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'author-image-option' . '-photo' ) );?>" class="radio-btn-wrap"><?php esc_html_e('Uploaded Photo','safari-blog');?></label>
            </p>
            ...
            <p>
                ...
                <button class="upload_image_button button button-primary"><?php esc_html_e( "Select Image", 'safari-blog' ); ?></button>
            </p>
            
            <p class="author-email">
                <label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Author Email', 'safari-blog' ); ?></label> 
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'email' ) ); ?>" type="text" value="<?php echo esc_attr( $email ); ?>" />
            </p>
            <div class="widget-side-note" class="example-text"><?php $grav_link = '<a href=' . esc_url( "http://en.gravatar.com/", 'safari-blog' ) . ' target="_blank">' . esc_html__( "Gravatar", 'safari-blog' ) . '</a>'; echo sprintf( __( 'You can show your %1$s image instead of manually uploading your photo. Just add your gravatar registered email address here.','safari-blog'), $grav_link );?></div>
            
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>"><?php esc_html_e( 'Description', 'safari-blog' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'label' ) ); ?>"><?php esc_html_e( 'Button Label', 'safari-blog' ); ?></label> 
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"><?php esc_html_e( 'Button Link', 'safari-blog' ); ?></label>
            ...
            <p>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php esc_html_e( 'Open in New Tab', 'safari-blog' ); ?></label>
            </p>
            

            <div class="widget-social-profile">
                <label><h3><?php esc_html_e( "Social Profile", 'safari-blog' ); ?></h3></label>
                
                <label for="<?php echo esc_attr( $this->get_field_id( 'social-facebook' ) ); ?>"><?php esc_html_e( 'Facebook Profile', 'safari-blog' ); ?></label> 
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'social-linkedin' ) ); ?>"><?php esc_html_e( 'LinkedIn Profile', 'safari-blog' ); ?></label> 
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'social-twitter' ) ); ?>"><?php esc_html_e( 'Twitter Profile', 'safari-blog' ); ?></label> 
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'social-instagram' ) ); ?>"><?php esc_html_e( 'Instagram Profile', 'safari-blog' ); ?></label> 
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance['image']          = ! empty( $new_instance['image'] ) ? sanitize_url( $new_instance['image'] ) : '';
            $instance['author-image']         = ! empty( $new_instance['author-image'] ) ? sanitize_url( $new_instance['author-image'] ) : '';
            $instance['label']         = ! empty( $new_instance['label'] ) ? wp_kses_post( $new_instance['label'] ) : '';
            $instance['link']         = ! empty( $new_instance['link'] ) ? sanitize_url( $new_instance['link'] ) : '';
            ...
            $instance['social-facebook']         = ! empty( $new_instance['social-facebook'] ) ? sanitize_url( $new_instance['social-facebook'] ) : '';
            $instance['social-linkedin']         = ! empty( $new_instance['social-linkedin'] ) ? sanitize_url( $new_instance['social-linkedin'] ) : '';
            $instance['social-twitter']         = ! empty( $new_instance['social-twitter'] ) ? sanitize_url( $new_instance['social-twitter'] ) : '';
