...
add_action( 'customize_register', 'safari_blog_customizer_premium_features' );

function safari_blog_customizer_premium_features( $wp_customize ) {
    ...
    $premium_features = '<div class="premium-info"><h2>' . esc_html__( 'Premium Version', 'safari-blog' ) . ': </h2>
	...
	<a class="button button-primary" href="' . esc_url( 'https://graphthemes.com/safari/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'safari-blog' ) . '</a></div>';

	$wp_customize->add_control( new Safari_Blog_Custom_Text( $wp_customize ,'premium_features',array(
