...
add_action( 'wp_enqueue_scripts', 'safari_blog_google_fonts_scripts' );
function safari_blog_google_fonts_scripts() {
    $args = safari_blog_used_google_fonts();
    wp_enqueue_style( 'google-fonts', safari_blog_fonts_url( $args ), array(), null );
}