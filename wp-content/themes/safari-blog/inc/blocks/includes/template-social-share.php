<script type="text/javascript">
	var fb = '<?php echo esc_html__( "Facebook", 'safari-blog' ); ?>';
	var twitter = '<?php echo esc_html__( "Twitter", 'safari-blog' ); ?>';
	var pinterest = '<?php echo esc_html__( "Pinterest", 'safari-blog' ); ?>';
	var linkedin = '<?php echo esc_html__( "Linkedin", 'safari-blog' ); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e( "Share", 'safari-blog' ); ?>:</li>
