...
add_action( 'customize_register', 'safari_blog_register_general_customization_section' );
function safari_blog_register_general_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'safari_blog_general_customization_section', array(
	    'title'	=> esc_html__( 'General Options', 'safari-blog' ),
	    'priority'	=> 21
	) );
