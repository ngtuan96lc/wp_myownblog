...
add_action( 'customize_register', 'safari_blog_color_section' );
function safari_blog_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'safari-blog' );
