...
add_action( 'customize_register', 'safari_blog_register_post_detail_customization_section' );
function safari_blog_register_post_detail_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'safari_blog_post_detail_customization_section', array(
	    'title'	=> esc_html__( 'Post Detail', 'safari-blog' ),
	    'priority'	=> 23
	) );
