...
add_action( 'customize_register', 'safari_blog_post_detail_category' );
function safari_blog_post_detail_category( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_category', array(
        'sanitize_callback'     =>  'safari_blog_sanitize_checkbox',
        'default'               =>  safari_blog_get_default_post_detail_category()
    ) );
